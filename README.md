...
Training time varies depending on dataset size and GPU (for this work we simulate ≈3 million tracks taking about a ≈14hrs on a single NVIDIA RTX A5000, ≈44 it/s with batch size 32 and convergence after ≈30 epochs).
