...
def combined_cps_k_focused(pred_series_alpha, pred_series_k, pred_series_state, window_size=5, include_state=False):
    """
...
def get_cps_ruptures(array, lower_limit=0, upper_limit=float("inf"), threshold=0.05):
